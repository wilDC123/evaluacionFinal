...
@section('content')
    <a href="{{ route('departments.create') }}" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Nuevo </a>
    <table id="departments" class="table table-bordered shadow-lg mt-12">
        <thead class="tabla-departments  text-white" style="background-color: #515E78;">
            <tr>
                <td width="15px">Nº</td>
...
<style>
    .tabla-departments th, .tabla-departments td {
        text-align: center;
    }
    .btn i {
        margin-right: 5px;
